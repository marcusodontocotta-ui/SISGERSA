...
ALTER TABLE pacientes ADD COLUMN IF NOT EXISTS numero_documentacao VARCHAR(50);
ALTER TABLE pacientes ADD COLUMN IF NOT EXISTS indicacao VARCHAR(200);
ALTER TABLE pacientes ADD COLUMN IF NOT EXISTS estado_civil VARCHAR(30);
ALTER TABLE pacientes ADD COLUMN IF NOT EXISTS profissao VARCHAR(100);
ALTER TABLE pacientes ADD COLUMN IF NOT EXISTS nome_pai VARCHAR(200);
ALTER TABLE pacientes ADD COLUMN IF NOT EXISTS nome_mae VARCHAR(200);
ALTER TABLE pacientes ADD COLUMN IF NOT EXISTS tipo_pagamento VARCHAR(20) DEFAULT 'particular';
